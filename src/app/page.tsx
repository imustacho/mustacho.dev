...
const socials = [
  {
    name: "GitHub",
    href: "https://github.com/imustacho",
    icon: FaGithub,
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/user/31ouiktnesnmb4l555pdsjevaqcm",
    icon: FaSpotify,
...
export default function Home() {
  return (
    <main className="min-h-screen relative overflow-hidden" style={{ color: ACCENT }}>
      <div className="pt-24 min-h-screen w-full flex flex-col justify-center">
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-5 max-w-2xl text-base text-[#7a451b] md:text-lg">
